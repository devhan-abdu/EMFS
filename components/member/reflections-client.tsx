    ...
    <div className="space-y-8">
      <div className="rise-in space-y-2">
        <p className="text-xs font-semibold uppercase tracking-wide text-teal">
          {batchName} · {paceGroupName}
        </p>
        <h1 className="font-display text-3xl font-semibold text-foreground md:text-4xl md:leading-tight">
          Reflections
        </h1>
        <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
          What did this week&apos;s pages leave with you? Write plainly — your
          pace group admin reads it, and your sisters can see it too.
        </p>
      </div>
      ...
      <Card className="card-soft">
        ...
        <CardContent className="space-y-4">
          <Textarea
            ...
            className="resize-none bg-surface-container"
          />
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          {others.map((r) => (
            <Card key={r.id} className="card-soft bg-surface-container/50">
              <CardContent className="space-y-2 p-6">
                <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
