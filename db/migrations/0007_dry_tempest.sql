...
CREATE TYPE "public"."move_request_status" AS ENUM('pending', 'approved', 'rejected', 'cancelled');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "pace_group_move_requests" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"profile_id" uuid NOT NULL,
	"batch_id" uuid NOT NULL,
	"from_pace_group_id" uuid,
	"to_pace_group_id" uuid NOT NULL,
	"reason" text,
	"status" "move_request_status" DEFAULT 'pending' NOT NULL,
	"reviewed_by" uuid,
...
--> statement-breakpoint
ALTER TABLE "pace_groups" ADD COLUMN "archived" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "pace_groups" ADD COLUMN "archived_at" timestamp;--> statement-breakpoint
ALTER TABLE "pace_group_memberships" ADD COLUMN "batch_id" uuid NOT NULL;--> statement-breakpoint
...
ALTER TABLE "pace_group_move_requests" ADD CONSTRAINT "pace_group_move_requests_profile_id_profiles_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pace_group_move_requests" ADD CONSTRAINT "pace_group_move_requests_batch_id_batches_id_fk" FOREIGN KEY ("batch_id") REFERENCES "public"."batches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pace_group_move_requests" ADD CONSTRAINT "pace_group_move_requests_from_pace_group_id_pace_groups_id_fk" FOREIGN KEY ("from_pace_group_id") REFERENCES "public"."pace_groups"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pace_group_move_requests" ADD CONSTRAINT "pace_group_move_requests_to_pace_group_id_pace_groups_id_fk" FOREIGN KEY ("to_pace_group_id") REFERENCES "public"."pace_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pace_group_move_requests" ADD CONSTRAINT "pace_group_move_requests_reviewed_by_profiles_id_fk" FOREIGN KEY ("reviewed_by") REFERENCES "public"."profiles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "daily_progress_profile_batch_idx" ON "daily_progress" USING btree ("profile_id","batch_id");--> statement-breakpoint
CREATE UNIQUE INDEX "unique_pending_move_request_idx" ON "pace_group_move_requests" USING btree ("profile_id","batch_id") WHERE status = 'pending';--> statement-breakpoint
CREATE INDEX "pace_group_move_requests_batch_id_idx" ON "pace_group_move_requests" USING btree ("batch_id");--> statement-breakpoint
CREATE INDEX "pace_group_move_requests_profile_id_idx" ON "pace_group_move_requests" USING btree ("profile_id");--> statement-breakpoint
CREATE INDEX "pace_group_move_requests_status_idx" ON "pace_group_move_requests" USING btree ("status");--> statement-breakpoint
CREATE INDEX "pace_group_move_requests_created_at_idx" ON "pace_group_move_requests" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "pace_group_memberships_status_idx" ON "pace_group_memberships" USING btree ("status");