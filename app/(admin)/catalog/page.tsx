      ...
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link
            ...
            className="inline-flex h-11 items-center gap-2 rounded-lg border border-border bg-surface-2 px-4 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-surface-container"
          >
